...
despesa_bp.route("/<int:despesa_id>", methods=["GET"])(DespesaController.get_por_id)
despesa_bp.route("/<int:despesa_id>", methods=["PUT"])(DespesaController.editar_despesa)
despesa_bp.route("/<int:despesa_id>", methods=["DELETE"])(DespesaController.excluir_despesa)
